...
func (s *FileStore) InstanceGroups(cluster string) store.InstanceGroupStore {
	return &InstanceGroupFileStore{container: s.container, prefix: s.prefix, cluster: cluster}
}
