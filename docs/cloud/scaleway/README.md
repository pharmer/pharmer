...
s1-master          Ready     master    23m       v1.11.0
vc1s-pool-ne36hc   Ready     node      1m        v1.11.0
vc1s-pool-t6knrw   Ready     node      1m        v1.11.0
```
...
You can now apply the upgrade by executing the following command:
	...
	pharmer edit cluster s1 --kubernetes-version=v1.11.1
